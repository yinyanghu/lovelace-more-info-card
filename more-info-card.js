! function(e) {
    ...
    e.exports = JSON.parse('{"name":"more-info-card","version":"1.1.0","description":"","private":true,"scripts":{"build":"webpack","watch":"webpack --watch --mode=development","update-card-tools":"npm uninstall card-tools && npm install thomasloven/lovelace-card-tools"},"author":"Thomas Lovén","license":"MIT","devDependencies":{"webpack":"^4.41.2","webpack-cli":"^3.3.10"},"dependencies":{"card-tools":"github:thomasloven/lovelace-card-tools"}}')
}, function(e, t, n) {
    "use strict";
    n.r(t);
    const o = customElements.get("home-assistant-main") ? Object.getPrototypeOf(customElements.get("home-assistant-main")) : Object.getPrototypeOf(customElements.get("hui-view")),
        r = o.prototype.html,
    ...
    if (customElements.define("more-info-card", class extends o {
            ...
            render() {
                if (!this.hass || !this.hass.states || !this.hass.states[this.config.entity]) return r `
        <ha-card
    ...
    `
        ...
        }), !customElements.get("more-info-card")) {
        customElements.define("more-info-card", BadgeCard);
        const e = n(0);
        console.info(`%cMORE-INFO-CARD ${e.version} IS INSTALLED`, "color: green; font-weight: bold", "")
    }
}]);
